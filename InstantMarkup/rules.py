...
class FormulaRule(Rule):
    """
    A formula is a block that starts with by '$$" and ends with '$$'.
    """
    type = 'formula'
    def condition(self, block):
...
class CodeRule(Rule):
    """
    A code is a block that starts with "```" and ends with "```".
    """
    type = 'code'
    def condition(self, block):
        return block.startswith("```")
...
class HtmlRule(Rule):
    """
    A html is a block that starts with "<" and ends with ">".
    """
    type = 'html'
    def condition(self, block):
        return block.startswith("<")
